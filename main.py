...
class Option:
	def __init__(self, game: Game, name: str, functionality: function, planet: Planet) -> None:
		self.game = game
		self.name = name
...
planet_names: List[Planet] = [random_planet_name() for i in range(7)]
